...
class UserLicenseAgreementScreenWidget extends StatefulWidget {
  const UserLicenseAgreementScreenWidget({Key key}) : super(key: key);

  @override
  _UserLicenseAgreementScreenWidgetState createState() =>
      _UserLicenseAgreementScreenWidgetState();
}

class _UserLicenseAgreementScreenWidgetState
    extends State<UserLicenseAgreementScreenWidget> {
